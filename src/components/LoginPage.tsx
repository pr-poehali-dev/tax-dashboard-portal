    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-6">
      <div className="w-full max-w-sm">
        <div className="mb-10 text-center">
          <div className="inline-flex items-center justify-center w-16 h-16 border-2 border-[hsl(var(--primary))]/40 mb-6 text-4xl">
            ⛏️
          </div>
          ...
          <p className="mt-2 text-muted-foreground text-xs uppercase tracking-widest font-sans">
            Личный кабинет Minecraft-сервера
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="Например: Steve2024"
        ...
        <p className="text-center text-muted-foreground/40 text-xs mt-8 tracking-wider">
          Доступ только для зарегистрированных игроков
        </p>
      </div>
    </div>
  );
